...
export default function StoryboardPage() {
  ...
  {getLabels(s).map((l: string) => {
    const o = s.options.find(opt => opt.name === l)
    return (
      <div key={l} style={{ fontFamily: 'system-ui, sans-serif', fontSize: 11, padding: '5px 12px', border: `0.5px solid ${br}`, borderRadius: 6, background: hv, color: ink, lineHeight: 1.5 }}>
